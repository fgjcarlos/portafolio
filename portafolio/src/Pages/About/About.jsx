...
const About = () => {
    ...
    return (
        <div className="ab-container">
                ...
                El mundo tecnológico siempre me ha apasionado desde pequeño. Desde la electrónica hasta la parte que más me gusta que es la programación. <br/>
<br/>
...
<br/>
Actualmente intento profundizar en los conocimientos adquiridos y poniéndolos en práctica con proyectos personales, hasta que me llegue una oportunidad para comenzar una carrera profesional en este sector.  <br/>
</p>
